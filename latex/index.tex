...
\begin{DoxyEnumerate}
\item \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/models/DomainModel-Midterm.png}{\texttt{ Domain Driven Diagram}} describes the development of reinforcement learning and greedy-\/based strategies. ~\newline

\item \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/models/SequenceDiagram-Midterm.png}{\texttt{ Sequence Diagram}} explains how the program performs in the sequential order.
\end{DoxyEnumerate}\hypertarget{index_autotoc_md5}{}\doxysubsection{Instructions}\label{index_autotoc_md5}
...
\begin{DoxyEnumerate}
\item For evaluations, you may compile \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/Evaluation.py}{\texttt{ Evaluation}} with your chosen number of trials. The figure for evaluations should be in a pop-\/up window.
\end{DoxyEnumerate}
...
\begin{DoxyEnumerate}
\item \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/test_InitializeTensor.py}{\texttt{ test\+\_\+\+Initalize\+Tensor}} is used to check and ensure that the types of parameters are correct. We have three tests to perform. You can compile it by\+:
\end{DoxyEnumerate}
...
{\bfseries{You could read \href{https://ck2860.github.io/MidtermCode-CondyKan/}{\texttt{ documentation}} for more details.}} If you have any questions, please feel free to email me at \href{mailto:ck2860@rit.edu}{\texttt{ ck2860@rit.\+edu}}.
