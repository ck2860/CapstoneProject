...
Both Mean\+Rewards\+Result and Tukey\+Data datasets are the results from the evaluations with 20 random seeds (\#1-\/\#20). The Mean Rewards Result data is used for T-\/tests and A\+N\+O\+VA. Lastly, the Tukey\+Data is used for the \mbox{\hyperlink{namespace_tukey}{Tukey}}\textquotesingle{}s Post Hoc Test.
...
You will be able to see five Pythons codes in the file, you could run them if you like! The figures for evaluations and the post hoc tests should be in pop-\/up windows. For evaluations, there are three Python program that you can run\+: \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/1trial.py}{\texttt{ 1trial}}, \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/10trials.py}{\texttt{ 10trials}}, and \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/20trials.py}{\texttt{ 20trials}}. 1trial code runs one trial of evaluation. 10trials code runs 10 trials of evaluation. Then 20trials code runs 20 trials of evaluation. You can evaluate by comparing strategies\textquotesingle{}s mean rewards. Last two Python programs\+: \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/StatsTests.py}{\texttt{ Stats\+Tests}} and \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/Tukey.py}{\texttt{ Tukey}} are used for statistical analysis. We analyze the results from the 20 trials evaluations. You can perform T-\/tests and A\+N\+O\+VA by running Stats\+Test.\+py code. After narrowing them down and performing the Post Hoc test, you may see the differences occurred between greedy-\/based strategies by compiling the Tukey.\+py file. Please read \href{https://ck2860.github.io/MidtermCode-CondyKan/}{\texttt{ documentation}} for more details.

Please open your Anaconda Prompt and go to the directory where you downloaded the project code. Please read the directions below before you run the code. Note that the {\ttfamily \$} is not part of the command.
...
For t-\/tests and A\+N\+O\+VA, you will only have one command-\/line argument\+: Stat\+Tests.\+py. You would want to run by\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\$ python StatsTests.py}
\end{DoxyCode}


Lastly, you can run a \mbox{\hyperlink{namespace_tukey}{Tukey}}\textquotesingle{}s Post Hoc Test with one command-\/line argument (Tukey.\+py) by\+: 
\begin{DoxyCode}{0}
