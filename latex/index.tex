...
\begin{DoxyEnumerate}
\item Clicking \char`\"{}\+Code\char`\"{} green button and \char`\"{}download Z\+I\+P\char`\"{} on the top right hand on the Git repository page.
\item Cloning the Git repository by performing git clone.
\end{DoxyEnumerate}
...
Both Mean Rewards Result and \mbox{\hyperlink{namespace_tukey}{Tukey}} datasets are the results from the evaluations with 20 random seeds (\#1-\/\#20). The Mean Rewards Result data is used for T-\/tests and A\+N\+O\+VA. Lastly, the \mbox{\hyperlink{namespace_tukey}{Tukey}} Data is used for \mbox{\hyperlink{namespace_tukey}{Tukey}} Test.
...
We have classes in the folder that would be utilized in the running codes. \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/ContextualBandit.py}{\texttt{ Contextual\+Bandit}}, \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/ContextualBanditAgent.py}{\texttt{ Contextual\+Bandit\+Agent}}, and \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/GreedyStrategies.py}{\texttt{ Greedy\+Strategies}} are for the evaluations. It would set contextual bandits up, run reinforcement learning, and use greedy-\/based strategies. Finally, \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/Plot.py}{\texttt{ Plot}} is programmed to plot evaluation results.

You will be able to see five Pythons codes in the file, you could run them if you like! The figures for evaluations and \mbox{\hyperlink{namespace_tukey}{Tukey}} should be in pop-\/up windows. For evaluations, there are three Python program that you can run\+: \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/1trial.py}{\texttt{ 1trial}}, \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/10trials.py}{\texttt{ 10trials}}, and \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/20trials.py}{\texttt{ 20trials}}. 1trial code runs one trial of evaluation. 10trials code runs 10 trials of evaluation. Then 20trials code runs 20 trials of evaluation. You can evaluate by comparing strategies\textquotesingle{}s mean rewards. Last two Python programs\+: \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/StatsTests.py}{\texttt{ Stats\+Tests}} and \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/Tukey.py}{\texttt{ Tukey}} are used for statistical analysis. We analyze the results from the 20 trials evaluations. You can perform T-\/tests and A\+N\+O\+VA by running \mbox{\hyperlink{namespace_stats_test}{Stats\+Test}} code. After narrowing them down and performing a \mbox{\hyperlink{namespace_tukey}{Tukey}} Pos Hoc test, you may see the differences occurred between greedy-\/based strategies by compiling \mbox{\hyperlink{namespace_tukey}{Tukey}} file. Please read \href{https://ck2860.github.io/MidtermCode-CondyKan/}{\texttt{ documentation}} for more details.
...
{\itshape Note that if you use a different random seed for 1trial file, the evaluation results may be different due to reinforcement learning and strategies.}
