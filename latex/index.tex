...
\begin{DoxyEnumerate}
\item For evaluations, you may compile \href{https://github.com/ck2860/MidtermCode-CondyKan/blob/master/Evaluation.py}{\texttt{ Evaluation}} with your chosen number of trials.
\end{DoxyEnumerate}
